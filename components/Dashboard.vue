<template>
  <div class="flex min-h-[100vh] sticky top-0 bg-gray-100 dark:bg-gray-600">
...
export default {
  ...
  computed: {
    ...
    buttonToggleSideBarClasses() {
      return `transform transition-transform duration-500 left-auto mt-2 ${this.isSidebarOpen ? "translate-x-52" : "translate-x-0"
        }`;
    },
    sideBarClasses() {
