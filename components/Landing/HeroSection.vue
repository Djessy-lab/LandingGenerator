  ...
  <div :class="colorMode.value === 'dark' ? 'bg-gray-900' : gradientClass">
    <header class="flex items-center justify-between p-4">
      ...
      <nav>
        <ul class="flex space-x-4">
          <li>
            <a href="#testimonials" :class="colorMode.value === 'dark' ? 'text-gray-200' : linkClass">Avis</a>
          </li>
          <li v-if="!userEmail">
    ...
    <section class="text-center py-12">
      ...
      <div v-if="!userEmail" class="mt-6 flex justify-center">
        <button @click="goLogin" :class="[
          `max-w-32 min-w-32 px-4 py-2 rounded-lg shadow`,
...
export default {
  ...
  computed: {
    ...
    imageClass() {
      let classes = `object-${this.imgHeroFit} object-${this.imgHeroPosition} w-full h-full`;
