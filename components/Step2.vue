  ...
  <div>
    ...
    <div class="space-y-4">
      ...
      <div v-if="advantages.length"
        :class="[seeAdvantages ? 'h-64' : 'h-10', 'rounded-lg p-4 w-[70%] max-h-64 max-lg:max-h-96 overflow-auto transition-all duration-500 ease-in-out']">
        <div class="mb-4 flex items-center">
          <p class="text-lg font-prompt">Nombre d'avantages ajoutés : {{ advantages.length }}</p>
          <button class="ml-5" @click.prevent="seeAdvantages = !seeAdvantages">
